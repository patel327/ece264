...
List * List_sort(List * list,int (*compar)(const char *arg1, const char *arg2)){
  ...
  List_sort(front, (*compar)(const char *arg1, const char *arg2));
  List_sort(back, (*compar)(const char *arg1, const char *arg2));
  list = List_merge(front,back,(*compar)(const char *arg1, const char *arg2));
  return list;
}
